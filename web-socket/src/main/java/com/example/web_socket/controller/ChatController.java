...
import com.example.web_socket.model.entity.ChatNotificaition;
import com.example.web_socket.service.ChatMessageService;
...
public class ChatController {
    ...
    public void processMessage(
        ...
        simpMessagingTemplate.convertAndSendToUser(
                ...
                ChatNotificaition.builder()
                        .id(saveMsg.getSenderId())
